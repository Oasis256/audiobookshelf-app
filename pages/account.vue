<template>
  <div class="w-full h-full p-4">
    ...
    <div class="flex justify-end items-center m-4 gap-3 right-0 bottom-0 absolute">
      <p class="text-smtext-yellow-400 text-right">&copy; The N-Line project
        <!-- <a class="underline"  href="https://github.com/advplyr/audiobookshelf-app" target="_blank">GitHub</a> -->
      </p>
